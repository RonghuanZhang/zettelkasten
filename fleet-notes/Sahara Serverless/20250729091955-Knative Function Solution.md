...
使用的版本为 v 0.46.0 [func\_yaml-schema.json](https://raw.githubusercontent.com/knative/func/refs/tags/v0.46.0/schema/func_yaml-schema.json)
...
## Tekton 创建 Pipeline 源码

```go
pkg/pipelines/tekton/pipelines_provider.go:109
```
