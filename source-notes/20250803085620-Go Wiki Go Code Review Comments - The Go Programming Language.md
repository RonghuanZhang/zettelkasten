---
type: source-note
title: "Go Wiki: Go Code Review Comments - The Go Programming Language"
id: 20250803080820
created: 2025-08-03T08:56:20
source:
  - web
...
- [Gofmt](https://go.dev/wiki/#gofmt)
- [Comment Sentences](https://go.dev/wiki/#comment-sentences)
- [Contexts](https://go.dev/wiki/#contexts)
- [Copying](https://go.dev/wiki/#copying)
- [Crypto Rand](https://go.dev/wiki/#crypto-rand)
- [Declaring Empty Slices](https://go.dev/wiki/#declaring-empty-slices)
- [Doc Comments](https://go.dev/wiki/#doc-comments)
- [Don’t Panic](https://go.dev/wiki/#dont-panic)
- [Error Strings](https://go.dev/wiki/#error-strings)
- [Examples](https://go.dev/wiki/#examples)
- [Goroutine Lifetimes](https://go.dev/wiki/#goroutine-lifetimes)
- [Handle Errors](https://go.dev/wiki/#handle-errors)
- [Imports](https://go.dev/wiki/#imports)
- [Import Blank](https://go.dev/wiki/#import-blank)
- [Import Dot](https://go.dev/wiki/#import-dot)
- [In-Band Errors](https://go.dev/wiki/#in-band-errors)
- [Indent Error Flow](https://go.dev/wiki/#indent-error-flow)
- [Initialisms](https://go.dev/wiki/#initialisms)
- [Interfaces](https://go.dev/wiki/#interfaces)
- [Line Length](https://go.dev/wiki/#line-length)
- [Mixed Caps](https://go.dev/wiki/#mixed-caps)
- [Named Result Parameters](https://go.dev/wiki/#named-result-parameters)
- [Naked Returns](https://go.dev/wiki/#naked-returns)
- [Package Comments](https://go.dev/wiki/#package-comments)
- [Package Names](https://go.dev/wiki/#package-names)
- [Pass Values](https://go.dev/wiki/#pass-values)
- [Receiver Names](https://go.dev/wiki/#receiver-names)
- [Receiver Type](https://go.dev/wiki/#receiver-type)
- [Synchronous Functions](https://go.dev/wiki/#synchronous-functions)
- [Useful Test Failures](https://go.dev/wiki/#useful-test-failures)
- [Variable Names](https://go.dev/wiki/#variable-names)
...
See [https://go.dev/doc/effective\_go#commentary](https://go.dev/doc/effective_go#commentary). Comments documenting declarations should be full sentences, even if that seems a little redundant. This approach makes them format well when extracted into godoc documentation. Comments should begin with the name of the thing being described and end in a period:
...
All top-level, exported names should have doc comments, as should non-trivial unexported type or function declarations. See [https://go.dev/doc/effective\_go#commentary](https://go.dev/doc/effective_go#commentary) for more information about commentary conventions.

## Don’t Panic

See [https://go.dev/doc/effective\_go#errors](https://go.dev/doc/effective_go#errors). Don’t use panic for normal error handling. Use error and multiple return values.
...
See [https://go.dev/doc/effective\_go#errors](https://go.dev/doc/effective_go#errors). Do not discard errors using `_` variables. If a function returns an error, check it to make sure the function succeeded. Handle the error, return it, or, in truly exceptional situations, panic.
...
See [https://go.dev/doc/effective\_go#mixed-caps](https://go.dev/doc/effective_go#mixed-caps). This applies even when it breaks conventions in other languages. For example an unexported constant is `maxLength` not `MaxLength` or `MAX_LENGTH`.
...
See [Named Result Parameters](https://go.dev/wiki/#named-result-parameters).
...
See [https://go.dev/doc/effective\_go#commentary](https://go.dev/doc/effective_go#commentary) for more information about commentary conventions.

## Package Names

All references to names in your package will be done using the package name, so you can omit that name from the identifiers. For example, if you are in package chubby, you don’t need type ChubbyFile, which clients will write as `chubby.ChubbyFile`. Instead, name the type `File`, which clients will write as `chubby.File`. Avoid meaningless package names like util, common, misc, api, types, and interfaces. See [https://go.dev/doc/effective\_go#package-names](https://go.dev/doc/effective_go#package-names) and [https://go.dev/blog/package-names](https://go.dev/blog/package-names) for more.
